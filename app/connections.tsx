    ...
    <ScrollView style={styles.scrollContainer}>
      <ThemedView style={styles.container}>
        ...
        <View style={styles.titleContainer}>
          <ThemedText style={styles.title}>My Crew</ThemedText>
          <TouchableOpacity
        ...
        {(filter || filterArea || filterCity) && city && (
          <View style={styles.locationFilterBadge}>
            ...
            <ThemedText style={styles.locationFilterBadgeText}>
        ...
        {/* Requests — only show when there are some */}
        ...
        {/* Pending — only show when there are some */}
          ...
          {filteredConnections.length > 0 ? (
            filteredConnections.map((connection) => (
              <View key={connection.id} style={styles.connectionCard}>
                ...
                >
                  <Ionicons name="ellipsis-vertical" size={18} color={Colors.text.disabled} />
                </TouchableOpacity>
              </View>
            ))
            ...
            <View style={styles.emptySection}>
              ...
              <TouchableOpacity
                style={{ marginTop: 16, backgroundColor: Colors.primary, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', gap: 6 }}
                onPress={() => router.push('/qr-code')}
              >
                <Ionicons name="person-add" size={18} color={Colors.white} />
                <ThemedText style={{ color: Colors.white, fontWeight: '600', fontSize: 15 }}>Add Crew</ThemedText>
              </TouchableOpacity>
            </View>
          )}
        </View>
